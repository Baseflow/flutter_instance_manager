...
import '../../src/android/android_instance_manager.pigeon.dart';

/// Host API for managing the native `InstanceManager`.
abstract class TestAndroidInstanceManagerHostApi {
  ...
  static void setup(TestAndroidInstanceManagerHostApi? api, {BinaryMessenger? binaryMessenger}) {
    {
